...
- `sitemap.xml` (main sitemap - regenerated by tools/generate-sitemaps.js)
- `sitemap-news.xml` (Google News sitemap - regenerated by tools/generate-sitemaps.js)
- `vercel.json` (clean URL rewrites - regenerated by tools/generate-sitemaps.js)
...
6. **REGENERATE SITEMAPS:** `node tools/generate-sitemaps.js`
   - This updates sitemap.xml, sitemap-news.xml, and vercel.json with the new report
7. `git add localreports/your-report.html js/reports-data.js sitemap.xml sitemap-news.xml vercel.json`
...
- Public URL is: `https://www.genuverity.com/slug-name` (clean, no path/extension)
- Vercel rewrites `/slug-name` → `/localreports/slug-name.html`
- `js/reports-data.js` uses clean slugs: `slug: "slug-name"` (NOT `"localreports/slug-name.html"`)
- The sitemap generator (`tools/generate-sitemaps.js`) auto-creates all rewrites in `vercel.json`
...
| `node tools/generate-sitemaps.js` | Regenerate sitemaps and clean URL rewrites |
...
AFTER ALL reports:
  7. Update js/reports-data.js with all entries (clean slug format: "slug-name")
  8. Run: node tools/generate-sitemaps.js
  9. git add localreports/*.html js/reports-data.js sitemap.xml sitemap-news.xml vercel.json
