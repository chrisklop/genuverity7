    ...
    <nav class="navbar">
        ...
        <div class="navbar-center" id="navSearchContainer">
            <div class="navbar-search-container">
                ...
                <input type="text" class="navbar-search-input" placeholder="Search Reports..." id="navSearchInput">
...
const SHARED_FOOTER_HTML = `
    <footer class="footer" style="margin-top:80px; padding:60px 0; text-align:center; border-top:1px solid var(--border-color); background:rgba(5,10,20,0.8); position:relative; z-index:10;">
        ...
        <div class="footer-links" style="display:flex; justify-content:center; gap:32px; flex-wrap:wrap;">
            ...
            <a href="/epstein-files/" style="color:var(--text-muted); text-decoration:none; transition:color 0.2s;">Epstein Files</a>
    ...
    if (navPlaceholder) {
        ...
        if (navRight) {
            navRight.innerHTML = `
                ...
                <a href="/epstein-files/" class="navbar-link" style="color:var(--text-secondary); text-decoration:none; padding:6px 10px; border-radius:8px; font-size:0.8rem; display:flex; align-items:center; gap:4px; transition:all 0.2s; white-space:nowrap; flex-shrink:0;">
        ...
        if (mobileLinks) {
            mobileLinks.innerHTML = `
                ...
                <a href="/epstein-files/"><i data-lucide="file-search" style="width:20px;"></i> Epstein Files</a>
