...
const REPORTS_DATA = [
    {
        ...
        sources: "34 Sources",
        readTime: "20 min",
        excerpt: "Forensic investigation into the multi-year information operation surrounding the non-existent Tesla Pi Phone. Analyzing the physics of solar charging, Starlink integration myths, and the $500M engagement economy driving the rumor mill.",
        chart: {
            type: "line",
            color: "#ef4444",
            data: [5, 15, 45, 85, 100, 95, 80]
        }
    },
    {
        id: 1,
